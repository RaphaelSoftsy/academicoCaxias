...
https://kit.fontawesome.com/3ce21ff22c.js"
  ...
  <body>
    ...
    <main class="container-section">
      <form class="container-section pb-5" id="formSubmit">
        ...
        >
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              <label for="relacionamentoId" class="form-label"
                >Relacionamento:<span class="red">*</span></label
              >
              <select
                class="form-select"
                required
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6">
              <label for="celular" class="form-label"
                >Celular:<span class="red">*</span></label
              >
              <input
                required
                type="tel"
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6">
              <label for="paisResidencialId" class="form-label"
                >País de Residencia:<span class="red">*</span>
              </label>
              <select
                class="form-select"
        ...
        >
          ...
          <div class="col-md-6" id="enderecoAlunoSwitch">
            <label for="isEnderecoAluno" class="form-label"
              >Utilizar o mesmo endereço do aluno?<span class="red">*</span>
            </label>
        ...
        >
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              <label for="telefoneComercial" class="form-label"
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/reservaVaga/dadosResponsavel.js"
    ></script>
    <script
      charset="UTF-8"
