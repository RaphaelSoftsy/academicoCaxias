      ...
      <section class="pt-4 card card-table px-5 py-3">
        ...
        >
          <h6 class="card-title" style="width: auto">
            Agora é só aguardar o contato da escola para a confirmação da
            matrícula.
          </h6>
          <h6 class="card-title" style="width: auto">
            Caso deseje, você já pode realizar o preenchimento da ficha médica
            do(a) aluno(a), para isto, basta clicar no botão abaixo.
          </h6>
        </div>
        ...
        <div class="row mt-3">
          <div class="col-md-12 text-center mt-3">
            <button
              ...
              id="btn-submit"
              onclick="window.location.href = 'reserva-ficha' "
            >
          ...
          <div class="col-md-12 text-center mt-3">
            <button
              ...
              class="btn btn-primary px-5"
              id="btn-submit"
              onclick="window.location.href = 'dadosResponsavel' "
            >
              Baixar declaração
            </button>
          </div>
