...
<body>
	...
	<main>
		<div class="container-login">
			<div
				style="background-image: url(<%=contextPath%>/resources/assets/img/bgLogin.jpg); background-size: cover;"
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/login/login.js"></script>
