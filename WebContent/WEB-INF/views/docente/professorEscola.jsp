...
https://kit.fontawesome.com/3ce21ff22c.js"
  ...
  <body>
      ...
      <section class="mb-5">
        <div class="card">
          <div class="card-body title">
            ...
            ><span id="span-title">Professor Escola</span>
          </div>
        </div>
      </section>
      <section class="pt-4">
                ...
                <div class="mb-4">
                  ...
                  <div class="custom-select">
                    <input
                      ...
                      autocomplete="off"
                    />
                    <ul class="options-list" id="escolaOptions"></ul>
                  </div>
                  <select
                    class="form-select"
                    aria-label="Escola"
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/docente/professorEscola.js"
    ></script>
