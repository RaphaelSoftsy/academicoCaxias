...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-cogs fa-lg"></i> <span>Orgão Público</span>
				</div>
			</div>
		</section>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="nome" class="form-label">Orgão Público:</label> <input
									type="text" class="form-control" id="cadastro-nome" required
									aria-describedby="atoRegulatorio" autocomplete="off">
							</div>
							<div class="mb-4">
								<label for="nome" class="form-label">Sigla:</label> <input
									type="text" class="form-control" id="cadastro-sigla" required
									aria-describedby="atoRegulatorio" autocomplete="off">
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="mb-4">
								<label for="nome" class="form-label">Sigla:</label> <input
									type="text" class="form-control" id="edit-sigla" required
									aria-describedby="atoRegulatorio" autocomplete="off">
							</div>
							<div class="d-flex justify-content-end gap-2">
							<button type="button" onclick='ativar("orgaoPublico")' class="ativar btn btn-secondary"
									data-bs-dismiss="modal">Ativar</button>
							<button type="button" onclick='desativar("orgaoPublico")' class="desativar btn btn-secondary"
	...
	<script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/orgaoPublico.js"></script>
