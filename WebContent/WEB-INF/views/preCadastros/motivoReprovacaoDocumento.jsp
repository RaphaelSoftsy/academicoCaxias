...
<body>
	...
	<main class="py-4 container-res">
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-cogs fa-lg"></i> <span>Motivo de Reprovação de Documento</span>
				</div>
			</div>
		</section>
		<section class="pt-4 card card-table px-5 py-3">
			...
			<table
				...
				<thead>
					<tr>
						<th scope="col">Motivo Reprovação</th>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="nome" class="form-label">Motivo:</label> <input
									type="text" class="form-control" id="motivo" required
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							<div class="mb-4">
								<label for="edit-nome" class="form-label">Motivo:</label> <input
									type="text" class="form-control" id="motivoEdit" required
									aria-describedby="Descricao" autocomplete="off">
							</div>
	...
	<script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/motivoReprovacaoDocumento.js"></script>
