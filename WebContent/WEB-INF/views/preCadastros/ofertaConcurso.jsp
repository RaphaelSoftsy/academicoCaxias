						...
						<form id="formCadastro">
							<div class="mb-4">
								...
								<select class="form-select" aria-label="concurso"
									id="concursoSelect" required name="concurso"
									style="display: none">
							...
							<div class="mb-4">
								...
								<select class="form-select" aria-label="escola"
									id="escolaSelect" required name="escola" style="display: none">
						...
						<form id="formEdit">
							<div class="mb-4">
								...
								<select class="form-select" aria-label="concursoEdit"
									id="concursoEdit" required name="concursoEdit"
									style="display: none">
									<option selected disabled value="">Selecione o
										Concurso</option>
								</select>
							...
							<div class="mb-4">
								...
								<select class="form-select" aria-label="cursoEdit"
									id="cursoEdit" required name="cursoEdit" style="display: none">
									<option selected disabled value="">Selecione o Curso</option>
								</select>
							</div>
							<div class="mb-4">
							...
							<div class="mb-4">
								...
								<select class="form-select" aria-label="turnoEdit"
									id="turnoEdit" required name="turnoEdit" style="display: none">
									<option selected disabled value="">Selecione o Turno</option>
								</select>
							</div>
