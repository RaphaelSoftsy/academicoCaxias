...
https://kit.fontawesome.com/3ce21ff22c.js"
  ...
  <body>
              ...
              <form id="formCadastro">
                ...
                <div class="mb-4">
                  <label for="curso" class="form-label"
                    >Curso:<span class="red">*</span></label
                  >
                  <div class="custom-select">
                    <input
                      type="text"
                ...
                <div class="mb-4">
                  <label for="serieId" class="form-label"
                    >Série:<span class="red">*</span></label
                  >
                  <div class="custom-select">
                    <input
                      type="text"
                ...
                <div class="mb-4">
                  <label for="vagasMin" class="form-label"
                    >Vagas Mínimas para Abertura:</label
                  >
                  <input
                    type="text"
                    class="form-control"
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formEdit">
                <div class="mb-4">
                  <label for="concursoEdit" class="form-label">Concurso:</label>
                  <div class="custom-select">
                    <input
                      type="text"
                      id="turmaSearchConcursoEdit"
                      class="form-control"
                      placeholder="Selecione ou pesquise..."
                      autocomplete="off"
                    />
                ...
                <div class="mb-4">
                  <label for="cursoEdit" class="form-label"
                    >Curso:<span class="red">*</span></label
                  >
                  <div class="custom-select">
                    <input
                      type="text"
                      id="turmaSearchCursoEdit"
                      class="form-control"
                      placeholder="Selecione ou pesquise..."
                      autocomplete="off"
                    />
                ...
                <div class="mb-4">
                  <label for="escolaEdit" class="form-label"
                    >Escola:<span class="red">*</span></label
                  >
                  <div class="custom-select">
                    <input
                      type="text"
                      id="turmaSearchEscolaEdit"
                      class="form-control"
                      placeholder="Selecione ou pesquise..."
                      autocomplete="off"
                    />
                ...
                <div class="mb-4">
                  <label for="turnoEdit" class="form-label"
                    >Turno:<span class="red">*</span></label
                  >
                  <div class="custom-select">
                    <input
                      type="text"
                      id="turmaSearchTurnoEdit"
                      class="form-control"
                      placeholder="Selecione ou pesquise..."
                      autocomplete="off"
                    />
                ...
                <div class="mb-4">
                  <label for="vagasEdit" class="form-label">Vagas:</label>
                  <input
                    type="number"
                    class="form-control"
                    id="vagasEdit"
                ...
                <div class="mb-4">
                  <label for="vagasMinEdit" class="form-label"
                    >Vagas Mínimas para Abertura:</label
                  >
                  <input
                    type="text"
                ...
                <div class="d-flex justify-content-end gap-2">
                  <button
                    type="button"
                    onclick='ativar("ofertasConcurso")'
                  ...
                  <button
                    type="button"
                    onclick='desativar("ofertasConcurso")'
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/ofertaConcurso.js"
    ></script>
    <script
      charset="UTF-8"
