...
<body>
	...
	<main class="py-4 container-res">
		...
		<section class="pt-4 card card-table px-5 py-3">
			...
			<table
				...
				<thead>
					<tr>
						<th scope="col">Tipo de Medição</th>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="nome" class="form-label">Tipo de Medição:</label> <input
	...
	<script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/tipoMedicao.js"></script>
