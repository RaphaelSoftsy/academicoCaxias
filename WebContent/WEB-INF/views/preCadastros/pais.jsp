...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-cogs fa-lg"></i> <span>Países</span>
				</div>
			</div>
		</section>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="nome" class="form-label">Código DDI:</label> <input
									type="text" class="form-control" id="cadastro-nome" required
									aria-describedby="Descricao" autocomplete="off">
							</div>
							<div class="mb-4">
								<label for="cadastro-nome2" class="form-label">País/Localidade:</label> <input
									type="text" class="form-control" id="cadastro-nome2" required
									aria-describedby="Descricao 2" autocomplete="off">
							</div>
							<div class="mb-4">
								<label for="cadastro-input3" maxlength="3" class="form-label" >Código ISO:</label> <input
									type="text" class="form-control" id="cadastro-input3" required
									aria-describedby="Descricao 3" autocomplete="off" oninput="this.value = this.value.toUpperCase()">
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="mb-4">
								<label for="edit-nome2" class="form-label">País/Localidade:</label> <input
									type="text" class="form-control" id="edit-nome2" required
									aria-describedby="Descricao 2" autocomplete="off">
							</div>
							<div class="mb-4">
								<label for="edit-input3" class="form-label">Código ISO:</label> <input
									type="text" maxlength="3" class="form-control" id="edit-input3" required
									aria-describedby="Descricao 3" autocomplete="off" oninput="this.value = this.value.toUpperCase()">
							</div>
							<div class="d-flex justify-content-end gap-2">
							<button type="button" onclick='remover("paises")'
	...
	<script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/pais.js"></script>
