...
<body>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="d-flex justify-content-end gap-2">
								<button type="button" onclick='ativar("localizacao")'
									class="ativar btn btn-secondary" data-bs-dismiss="modal">Ativar</button>
								<button type="button" onclick='desativar("localizacao")'
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/localizacao.js"></script>
