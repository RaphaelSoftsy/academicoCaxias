...
<html>
  ...
  <body>
            ...
            <div class="modal-body">
              <form id="formEdit">
                ...
                <div class="d-flex justify-content-end gap-2">
                  <button
                    type="button"
                    onclick='ativar("marcaEquipamento")'
                  ...
                  <button
                    type="button"
                    onclick='desativar("marcaEquipamento")'
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/marcaEquipamento.js"></script>
