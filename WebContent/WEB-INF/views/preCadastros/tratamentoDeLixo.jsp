...
<body>
	...
	<main class="py-4 container-res">
		<section class="mb-5">
			<div class="card card-title">
				...
				<div class="info">
					<div class="tooltiptext">O tratamento de lixo é uma parte
						fundamental da gestão de resíduos para minimizar os impactos
						negativos no meio ambiente e na saúde humana.</div>
	...
	<script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/tratamentoDeLixo.js"></script>
