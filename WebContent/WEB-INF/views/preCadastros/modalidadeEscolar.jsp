...
<body>
			...
			<div class="mt-3 mb-3" style="display: flex; align-items: center">
				<div class="col-6">
					<div class="input-group">
						<input id="inputBusca" type="text" class="form-control searchInput inputForm"
							placeholder="Buscar" /> <span style="cursor: pointer"
							class="input-group-text searchButton icone-pesquisa"><i
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="nome" class="form-label">Modalidade Escolar:</label>
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/modalidadeEscolar.js"></script>
	<script charset="UTF-8"
