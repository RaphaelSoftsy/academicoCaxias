...
<body>
	...
	<main class="py-4 container-res">
		...
		<section class="pt-4 card card-table px-5 py-3">
			...
			<table
				...
				<thead>
					<tr>
						<th scope="col">Provedor Internet</th>
						<th scope="col">Telefone Provedor</th>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="nome" class="form-label">Provedor Internet:</label> <input
									type="text" class="form-control" id="cadastro-nome" required
									aria-describedby="atoRegulatorio" autocomplete="off">
							</div>
							<div class="mb-4">
								<label for="nome" class="form-label">Telefone Provedor:</label> <input
									type="text" class="form-control" id="cadastro-tel" required
									aria-describedby="atoRegulatorio" autocomplete="off">
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="mb-4">
								<label for="nome" class="form-label">Telefone Provedor:</label> <input
									type="text" class="form-control" id="edit-tel" required
									aria-describedby="atoRegulatorio" autocomplete="off">
							</div>
							<div class="d-flex justify-content-end gap-2">
							<button type="button" onclick='ativar("provedorInternet")' class="ativar btn btn-secondary"
									data-bs-dismiss="modal">Ativar</button>
							<button type="button" onclick='desativar("provedorInternet")' class="desativar btn btn-secondary"
	...
	<script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/provedorInternet.js"></script>
