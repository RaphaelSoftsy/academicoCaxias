...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-cogs fa-lg"></i> <span>Tipo Ato
						Regulatório</span>
				</div>
			</div>
		</section>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="nome" class="form-label">Tipo Ato
									Regulatório:</label> <input type="text" class="form-control"
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/tipoAtoRegulatorio.js"></script>
	<script charset="UTF-8"
