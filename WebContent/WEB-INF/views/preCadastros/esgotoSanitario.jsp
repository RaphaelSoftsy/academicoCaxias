...
<body>
	...
	<main class="py-4 container-res">
		<section class="mb-5">
			<div class="card card-title">
				<div class="card-body title">
					<i class="fa-solid fa-cogs fa-lg"></i> <span>Esgotamento
						Sanitário</span>
				</div>
				<div class="info">
					<div class="tooltiptext">Esgotamento Sanitário sistema de
						coleta, transporte, tratamento e disposição final adequada dos
						esgotos, visando proteger a saúde pública e o meio ambiente.</div>
		...
		<section class="pt-4 card card-table px-5 py-3">
			...
			<table
				...
				<thead>
					<tr>
						<th scope="col">Esgotamento Sanitário</th>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="nome" class="form-label">Esgotamento
									Sanitário:</label> <input type="text" class="form-control"
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="d-flex justify-content-end gap-2">
								<button type="button" onclick='ativar("esgotamentoSanitario")'
									class="ativar btn btn-secondary" data-bs-dismiss="modal">Ativar</button>
								<button type="button"
									onclick='desativar("esgotamentoSanitario")'
	...
	<script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/esgotoSanitario.js"></script>
