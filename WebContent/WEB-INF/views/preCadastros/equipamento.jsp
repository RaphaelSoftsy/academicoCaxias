...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-cogs fa-lg"></i> <span>Equipamentos</span>
				</div>
			</div>
		</section>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="nome" class="form-label">Equipamento:</label> <input
									type="text" class="form-control" id="cadastro-nome" required
									aria-describedby="Descricao" autocomplete="off">
							</div>
							<div class="mb-4">
								<label for="selectCadastro" class="form-label">Marca do Equipamento:<span
									class="red">*</span>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="mb-4">
								<label for="selectEdit" class="form-label">Marca do Equipamento:<span
									class="red">*</span>
							...
							<div class="d-flex justify-content-end gap-2">
								<button type="button" onclick='ativar("equipamento")'
									class="ativar btn btn-secondary" data-bs-dismiss="modal">Ativar</button>
								<button type="button" onclick='desativar("equipamento")'
	...
	<script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/equipamento.js"></script>
