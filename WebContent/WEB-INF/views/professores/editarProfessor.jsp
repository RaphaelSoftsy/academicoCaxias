...
<html>
  ...
  <body>
      ...
      <section class="pt-4">
        <form id="formNovoCadastro" class="pt-4">
          ...
          >
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <label for="paisResidenciaId" class="form-label"
                  >País de Residência:<span class="red">*</span>
                </label>
                <select
                  class="form-select"
          ...
          >
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <label for="rgNumero" class="form-label"
                  >RG: <span class="red">*</span></label
                >
                <input
                  type="text"
                  id="rgNumero"
              ...
              <div class="col-md-6" id="rgDataExpedicaoDiv">
                <label for="rgDataExpedicao" class="form-label"
                  >RG Data de Expedição:<span class="red">*</span>
                </label>
                <input
                  type="date"
                  id="rgDataExpedicao"
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <label for="rgOrgaoExpedidor" class="form-label"
                  >Órgão Expedidor-RG:<span class="red">*</span>
                </label>
                <input
                  type="text"
                  id="rgOrgaoExpedidor"
              ...
              <div class="col-md-6">
                <label for="rgUfEmissorId" class="form-label"
                  >UF Emissor - RG:<span class="red">*</span>
                </label>
                <select
                  class="form-select"
          ...
          >
            ...
            >
              <label for="qualPreencher" class="form-label"
                >Qual deseja preencher?
              </label>
              <div
                class="form-control card-form qualPreencherSwitch"
                style="width: 100%"
              >
          ...
          >
            ...
            <div class="row mb-3">
              ...
              >
                <label
                  for="certidaoNascimentoMunicipioCartorioId"
                  class="form-label"
          ...
          >
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <label
                  for="certidaoCasamentoMunicipioCartorioId"
                  class="form-label"
                ...
                <select
                  ...
                  name="certidaoCasamentoMunicipioCartorioId"
                  disabled
                >
                  <option selected disabled value="">
                    Selecione uma opção
          ...
          >
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <label for="codigoInep" class="form-label">Código INEP: </label>
                <input
                  type="text"
                  id="codigoInep"
                  autocomplete="off"
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <label for="dataContratacao" class="form-label"
                  >Data de Contratação:
                </label>
                <input
                  type="date"
              ...
              <div class="col-md-6">
                <label for="dataDemissao" class="form-label"
                  >Data de Demissão:
                </label>
                <input
                  type="date"
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <label for="emailInstucional" class="form-label"
                  >Email Institucional:
                </label>
                <input
                  type="text"
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/professores/editarProfessor.js"
    ></script>
    <script
      charset="UTF-8"
