  ...
  <body>
    ...
    <main class="py-4 container-res">
      ...
      <section class="pt-4">
        ...
        >
          <h1 id="tituloForm" class="text-center mb-5">Dados do Professor</h1>
          <input
            type="text"
            id="usuarioCadastro"
            hidden
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6">
              <button
                type="button"
                onclick='ativar2("professores")'
                class="ativar btn btn-secondary mt2"
              >
                Ativar
              </button>
              <button
                type="button"
                onclick='desativar2("professores")'
                class="desativar btn btn-secondary mt2"
              >
                Desativar
              </button>
            </div>
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/professores/editarProfessor.js"></script>
