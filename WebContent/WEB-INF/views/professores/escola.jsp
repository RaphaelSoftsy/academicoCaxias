...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-chalkboard-user fa-lg"></i> <span>Professor
						Escola</span>
				</div>
			</div>
		</section>
					...
					<tr>
						<th scope="col" class="sortable border-end"
							...
							<div
								...
								<div
									...
									<span>Professor</span> <i class="fas fa-sort me-3"
						...
						<th scope="col" class="sortable border-end"
							...
							<div
								...
								<div
									class="col d-flex align-items-center justify-content-between">
									<span>Cargo</span> <i class="fas fa-sort me-3"
										style="color: #dddddd"></i>
								</div>
							</div>
						</th>
						...
						<th scope="col" class="sortable border-end"
							...
							<div
								...
								<div
									class="col d-flex align-items-center justify-content-between">
									<span>Data de Nomenclatura</span> <i class="fas fa-sort me-3"
										style="color: #dddddd"></i>
								</div>
								<div class="dropdown-form">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="professorId" class="form-label">Professor:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Escola"
									id="professorId" required name="professorId">
							...
							<div class="mb-4">
								<label for="turnoProfessorId" class="form-label">Turno:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Escola"
									id="turnoProfessorId" required name="turnoProfessorId">
							...
							<div class="mb-4">
								<label for="cargoProfessorId" class="form-label">Cargo:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Escola"
									id="cargoProfessorId" required name="cargoProfessorId">
									<option selected disabled value="">Selecione uma opção
									</option>
								</select>
							</div>
							...
							<div class="mb-4">
								<label for="dtNomenclatura" class="form-label">Data
									de Nomenclatura:<span class="red">*</span>
								</label> <input max="2999-01-01" autocomplete="off" type="date"
									id="dtNomenclatura" name="dtNomenclatura" class="form-control" />
							</div>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							<div class="mb-4">
								<label for="professorIdEdit" class="form-label">Professor:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Escola"
									id="professorIdEdit" required name="professorIdEdit">
									<option selected disabled value="">Selecione o
										professor</option>
								</select>
							</div>
							...
							<div class="mb-4">
								<label for="turnoProfessorIdEdit" class="form-label">Turno:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Escola"
									id="turnoProfessorIdEdit" required name="turnoProfessorIdEdit">
									<option selected disabled value="">Selecione uma opção
									</option>
								</select>
							</div>
							...
							<div class="mb-4">
								<label for="cargoProfessorIdEdit" class="form-label">Cargo:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Escola"
									id="cargoProfessorIdEdit" required name="cargoProfessorIdEdit">
									<option selected disabled value="">Selecione uma opção
									</option>
								</select>
							</div>
							...
							<div class="mb-4">
								<label for="dtNomenclaturaEdit" class="form-label">Data
									de Nomenclatura:<span class="red">*</span>
								</label> <input max="2999-01-01" autocomplete="off" type="date"
									id="dtNomenclaturaEdit" name="dtNomenclaturaEdit"
									class="form-control" />
							</div>

							<div class="d-flex justify-content-end gap-2">
								<button type="button" onclick='ativar("professorEscola")'
									class="ativar btn btn-secondary" data-bs-dismiss="modal">
									Ativar</button>
								<button type="button" onclick='desativar("professorEscola")'
	...
	<script charset="UTF-8" 
		src="<%=contextPath%>/resources/assets/js/professores/escola.js"></script>
