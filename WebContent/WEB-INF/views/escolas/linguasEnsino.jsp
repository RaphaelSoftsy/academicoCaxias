...
<html>
  ...
  <body>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formCadastro">
                <div class="mb-4">
                  <label for="idLinguaEnsino" class="form-label"
                    >Língua de Ensino:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Língua de Ensino"
                    id="idLinguaEnsino"
                    required
                    name="idLinguaEnsino"
                  >
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formEdit">
                ...
                <div class="mb-4">
                  <label for="idLinguaEnsinoEdit" class="form-label"
                    >Língua de Ensino:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Língua de Ensino"
                    id="idLinguaEnsinoEdit"
                    required
                    name="idLinguaEnsinoEdit"
                  >
                    <option selected value="" disabled>
                      Selecione a Língua
                    </option>
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/escolas/linguasEnsino.js"></script>
