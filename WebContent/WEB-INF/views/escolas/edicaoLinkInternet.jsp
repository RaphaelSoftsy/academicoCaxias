...
<body>
		...
		<section class="pt-4">
			<form id="formEditar"
				...
				<div class="row mb-5 justify-content-center">
					...
					<div class="col-md-4">
						<label for="velocidadeMb" class="form-label">Velocidade da
							Internet:<span class="red">*</span>
						</label> <input type="number" id="velocidadeMb" required
							autocomplete="off" name="velocidadeMb" class="form-control" />
					</div>
				...
				<div class="row mb-5 justify-content-center">
						...
						<div class="form-control">
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio"
									name="administrativo" id="administrativoS" value="S"> <label
									class="form-check-label" for="administrativoS">Sim</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio"
									name="administrativo" id="administrativoN" value="N"> <label
									class="form-check-label" for="administrativoN">Não</label>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<label for="estudante" class="form-label">Estudante:<span
							class="red">*</span>
						</label>
						<div class="form-control">
							<div class="form-check form-check-inline">
					...
					<div class="col-md-8">
						<button type="button" onclick='ativar("escolaLinkInternet")'
							class="ativar btn btn-secondary mt-4" data-bs-dismiss="modal">Ativar</button>
						<button type="button" onclick='desativar("escolaLinkInternet")'
	...
	<script charset="UTF-8" 
		src="<%=contextPath%>/resources/assets/js/escolas/edicaoLinkInternet.js"></script>
