...
<html>
  ...
  <body>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formCadastro">
                ...
                <div class="mb-4">
                  <label for="tipoProfissionalId" class="form-label"
                    >Tipo Profissional:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Profissional"
                    id="tipoProfissionalId"
                    required
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formEdit">
                ...
                <div class="mb-4">
                  <label for="tipoProfissionalIdEdit" class="form-label"
                    >Tipo Profissional:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Profissional"
                    id="tipoProfissionalIdEdit"
                    required
                    name="tipoProfissionalIdEdit"
                  >
                ...
                <div class="d-flex justify-content-end gap-2">
                  <button
                    type="button"
                    onclick='remover("escolaProfissional")'
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/escolas/profissional.js"></script>
