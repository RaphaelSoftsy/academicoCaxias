...
<html>
  ...
  <body>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formCadastro">
                <div class="mb-4">
                  <label for="idEsgotamentoSanitario" class="form-label"
                    >Esgotamento Sanitário:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Esgotamento Sanitário"
                    id="idEsgotamentoSanitario"
                    required
                    name="idEsgotamentoSanitario"
                  >
                    <option selected value="" disabled>
                      Selecione o Esgotamento
                    </option>
                  </select>
                </div>
                <div class="mb-4" style="display: none"  id="escolaIdStyle">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formEdit">
                ...
                <div class="mb-4">
                  <label for="idEsgotamentoSanitarioEdit" class="form-label"
                    >Esgotamento Sanitário:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Esgotamento Sanitário"
                    id="idEsgotamentoSanitarioEdit"
                    required
                    name="idEsgotamentoSanitarioEdit"
                  >
                    <option selected value="" disabled>
                      Selecione o Esgotamento
                    </option>
                ...
                <div class="d-flex justify-content-end gap-2">
                  <button
                    type="button"
                    onclick='remover("escolaEsgotamentoSanitario")'
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/escolas/esgotamentoSanitario.js"></script>
