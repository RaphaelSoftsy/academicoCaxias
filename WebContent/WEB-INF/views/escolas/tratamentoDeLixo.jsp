...
<html>
  ...
  <body>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formCadastro">
                <div class="mb-4">
                  <label for="tratamentoLixoId" class="form-label"
                    >Tratamento de Lixo:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="tratamentoLixoId"
                    id="tratamentoLixoId"
                    required
                    name="Tratamento de Lixo"
                  >
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formEdit">
                ...
                <div class="mb-4">
                  <label for="tratamentoLixoIdEdit" class="form-label"
                    >Tratamento de Lixo:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Tratamento de Lixo"
                    id="tratamentoLixoIdEdit"
                    required
                    name="tratamentoLixoIdEdit"
                  >
                    <option selected value="" disabled>
                      Selecione o Tratamento
                    </option>
                ...
                <div class="d-flex justify-content-end gap-2">
                  <button
                    type="button"
                    onclick='remover("escolaTratamentoLixo")'
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/escolas/tratamentoLixo.js"></script>
