...
<html>
  ...
  <body>
      ...
      <section class="mb-5">
        <div class="card">
          <div class="card-body title">
            ...
            <span>Instrutores Pedagógicos</span>
          </div>
        </div>
      </section>
              ...
              >
                ...
                >
                  <div
                    class="col d-flex align-items-center justify-content-between"
                  >
                    <span>Instrutor Pedagógico</span>
                    <i class="fas fa-sort me-3" style="color: #dddddd"></i>
                  </div>
                  <div class="dropdown-form">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formCadastro">
                ...
                <div class="mb-4">
                  <label for="instrPedagogicoId" class="form-label"
                    >Instrutor Pedagógico:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Instrutor Pedagógico"
                    id="instrPedagogicoId"
                    required
                    name="instrPedagogicoId"
                  >
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formEdit">
                ...
                <div class="mb-4">
                  <label for="instrPedagogicoIdEdit" class="form-label"
                    >Instrutor Pedagógico:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Instrutor Pedagógico"
                    id="instrPedagogicoIdEdit"
                    required
                ...
                <div class="d-flex justify-content-end gap-2">
                  <button
                    type="button"
                    onclick='ativar("escolaInstrPedagogico")'
                  ...
                  <button
                    type="button"
                    onclick='desativar("escolaInstrPedagogico")'
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/escolas/instrPedagogico.js"></script>
