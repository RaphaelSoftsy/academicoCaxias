...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-school fa-lg"></i> <span>Modalidades</span>
				</div>
			</div>
		</section>
					...
					<tr>
						...
						<th scope="col" class="sortable border-end"
							...
							<div
								...
								<div
									class="col d-flex align-items-center justify-content-between">
									<span>Modalidade</span> <i class="fas fa-sort me-3"
										style="color: #dddddd"></i>
								</div>
								<div class="dropdown-form">
						...
						<th class="text-center" scope="col" class="border-end pe-2 th-sem-filtro"
							data-column="ativo" width="10%">Ações</th>
					</tr>
				</thead>
		...
		<div class="modal fade" id="editItem" tabindex="-1"
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							<div class="mb-4 none" id="escolaIdStyle">
							...
							<div class="mb-4">
								<label for="modalidadeEscolaIdEdit" class="form-label">Modalidade:<span
									...
									id="modalidadeEscolaIdEdit" required
									name="modalidadeEscolaIdEdit">
									<option selected disabled>Selecione a Modalidade</option>
								</select>
							</div>
							<div class="d-flex justify-content-end gap-2">
								<button type="button" onclick='remover("escolaModalidade")'
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/escolas/escolaModalidade.js"></script>
	<script charset="UTF-8"
