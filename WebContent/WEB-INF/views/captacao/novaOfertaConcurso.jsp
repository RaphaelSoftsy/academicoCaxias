...
<body>
	...
	<main class="py-4 container-res">
		...
		<section class="pt-4">
			<form id="formNovoCadastro"
				...
				<h1 id="tituloForm" class="text-center mb-5">Cadastrar Oferta
					Concurso</h1>
				...
				<div class="row mb-3">
					<div class="col-md-6">
						<label for="concursoId" class="form-label">Concurso:<span
							class="red">*</span></label> <select class="form-select"
							aria-label="concursoId" id="concursoId" required
							name="concursoId">
					...
					<div class="col-md-6">
						<label for="cursoId" class="form-label">Curso:<span
							class="red">*</span>
						</label> <select class="form-select" aria-label="cursoId" id="cursoId"
				...
				<div class="row mb-3">
					<div class="col-md-6">
						<label for="serieId" class="form-label">Série:<span
							class="red">*</span></label> <select class="form-select"
							aria-label="serieId" id="serieId" required name="serieId">
				...
				<div class="row mb-3">
					...
					<div class="col-md-6">
						<label for="vagas" class="form-label">Vagas:<span
							class="red">*</span>
						</label> <input type="text" id="vagas" autocomplete="off" name="vagas"
							class="form-control" />
					</div>
				</div>
				<div class="row mb-3">
					<div class="col-md-6">
						<label for="vagasMin" class="form-label">Vagas Mínimas
							para Abertura: </label> <input type="text" id="vagasMin"
							autocomplete="off" name="vagasMin" class="form-control" />
					</div>
				</div>
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/captacao/novaOfertaConcurso.js"></script>
