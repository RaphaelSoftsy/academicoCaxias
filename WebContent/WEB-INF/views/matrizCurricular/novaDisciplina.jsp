...
https://kit.fontawesome.com/3ce21ff22c.js"
  ...
  <body>
        ...
        >
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <select
                class="form-select"
                aria-label="Area de Conhecimento"
          ...
          <div class="row mb-3 justify-content-center">
            ...
            <div class="col-md-6">
              <label for="disciplina" class="form-label"
                >Código da disciplina (Exem: MAT):<span class="red">*</span>
              </label>
              <input
                type="text"
                id="disciplina"
          ...
          <div class="row mb-3 justify-content-center">
            ...
            <div class="col-md-6">
              <label for="horasAnual" class="form-label"
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/matrizCurricular/novaDisciplina.js"
    ></script>
    <script
      charset="UTF-8"
