...
<body>
	...
	<main class="py-4 container-res">
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-cogs fa-lg"></i> <span>Situação aluno</span>
				</div>
			</div>
		</section>
			...
			<div class="mt-3 mb-3"
				...
				<div class="d-flex align-items-center gap-2 ">
					...
					<button class="btn btn-primary btn-lg btn-new-alter px-3 py-1 ms-auto"
						data-bs-toggle="modal" data-bs-target="#newCadastro">Novo Cadastro</button>
				</div>
			</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="situacaoAluno" class="form-label">Situação aluno:</label> <input
									type="text" class="form-control" id="situacaoAluno" required
									aria-describedby="situacaoAluno" autocomplete="off"
									name="situacaoAluno">
							</div>
		...
		<div class="modal fade" id="editarSituacao" tabindex="-1"
			aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						<h1 class="modal-title fs-5" id="title-novo-ato">Editar
							Cadastro</h1>
						<button type="button" class="btn-close" data-bs-dismiss="modal"
							aria-label="Close"></button>
					</div>
					<div class="modal-body">
						<form id="formEdit">
							<div class="mb-4">
								<label for="situacaoAlunoEdit" class="form-label">Situação aluno:</label> <input
									type="text" class="form-control" id="situacaoAlunoEdit" required
									aria-describedby="situacaoAlunoEdit" autocomplete="off"
									name="situacaoAlunoEdit">
							</div>
							<div class="d-flex justify-content-end gap-2">
								<button type="button" class="btn btn-secondary"
									data-bs-dismiss="modal">Fechar</button>
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/matrizCurricular/situacaoAluno.js"></script>
	<script charset="UTF-8"
