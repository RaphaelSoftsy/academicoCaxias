	...
	<main class="py-4 container-res">
		...
		<section class="pt-4">
			<form id="formNovoCadastro"
				...
				<div class="row mb-3">
					<div class="col-md-6">
						<label for="nomeCurriculo" class="form-label">Nome do
							currículo:<span class="red">*</span>
						</label> <input type="text" id="nomeCurriculo" required autocomplete="off"
							name="nomeCurriculo" class="form-control" />
					</div>
				...
				<div class="row mb-3">
					...
					<div class="col-md-6">
						<label for="descCurriculo" class="form-label">Descrição: <span class="red">*</span>
						</label> <input type="text" id="descCurriculo" required autocomplete="off"
							name="descCurriculo" class="form-control" />
					</div>
					<div class="col-md-6">
						<label for="codCursoInpe" class="form-label">Código do
							curso inep:<span class="red">*</span>
