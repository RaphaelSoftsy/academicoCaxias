...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-chalkboard-user fa-lg"></i> <span>Professores</span>
				</div>
			</div>
		</section>
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/matrizCurricular/professores.js"></script>
	<script charset="UTF-8"
