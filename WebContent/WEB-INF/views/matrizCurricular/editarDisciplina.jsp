...
https://kit.fontawesome.com/3ce21ff22c.js"
  ...
  <body>
    ...
    <main class="py-4 container-res">
      ...
      <section class="pt-4">
        ...
        >
          <h1 id="tituloForm" class="text-center mb-5">Dados da Disciplina</h1>
 ...
 -->
          ...
          <div class="row mb-3 justify-content-center">
            <div class="col-md-6">
              <label for="horasSemanal" class="form-label"
                >Carga Horária Semanal:<span class="red">*</span>
              </label>
              <input
                type="number"
                id="horasSemanal"
            ...
            <div class="col-md-6">
              <label for="horasAno" class="form-label"
                >Carga Horária Anual:<span class="red">*</span>
              </label>
              <input
                type="number"
                id="horasAno"
          ...
          <div class="row mb-3 text-center mt-3">
            <div class="col-md-6">
              <button
                ...
                class="ativar btn btn-success mt-4"
              ...
              <button
                type="button"
                onclick='desativar("disciplina")'
                class="desativar btn btn-danger mt-4"
                data-bs-dismiss="modal"
              >
                Desativar
              </button>
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/matrizCurricular/editarDisciplina.js"
    ></script>
    <script
      charset="UTF-8"
