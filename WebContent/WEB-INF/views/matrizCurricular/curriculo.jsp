				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							...
							<div class="row mb-4">
								<div class="col-6">
									<label for="dtHomologacao" class="form-label">Data de
										homologação: </label> <input max="2999-01-01" autocomplete="off"
										type="date" id="dtHomologacao" name="dtHomologacao"
										class="form-control" />
								</div>
								<div class="col-6">
									<label for="dtExtincao" class="form-label">Data de
										extinção: </label> <input max="2999-01-01" autocomplete="off"
							...
							<div class="row mb-4">
								<div class="col-6">
									<label for="prazoIdeal" class="form-label">Prazo ideal:
									</label> <input autocomplete="off" type="number" id="prazoIdeal"
										name="prazoIdeal" class="form-control" />
								</div>
								<div class="col-6">
									<label for="prazoMax" class="form-label">Prazo máximo:
							...
							<div class="d-flex justify-content-end gap-2">
								...
								<button type="submit" data-bs-dismiss="modal"
									class="btn btn-primary px-4" id="btn-submit">Salvar</button>
							</div>
						</form>
					</div>
				</div>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							<div class="mb-4">
								<label for="cursoIdEdit" class="form-label">Curso:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Curso" id="cursoIdEdit"
									required name="cursoIdEdit">
							...
							<div class="row mb-4">
								...
								<div class="col-6">
									<label for="dtExtincaoEdit" class="form-label">Data de
										extinção: </label> <input max="2999-01-01" autocomplete="off"
							...
							<div class="d-flex justify-content-end gap-2">
								...
								<button type="button" class="btn btn-secondary"
									data-bs-dismiss="modal">Fechar</button>
								<button type="submit" data-bs-dismiss="modal"
									class="btn btn-primary px-4" id="btn-editar">Salvar</button>
							</div>
						</form>
					</div>
				</div>
