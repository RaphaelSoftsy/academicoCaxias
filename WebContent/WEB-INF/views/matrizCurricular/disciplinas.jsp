		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-school fa-lg"></i> <span>Disciplinas</span>
				</div>
			</div>
		</section>
		<section class="pt-4 card card-table px-5 py-3">
			<div class="mt-3 mb-3"
				...
				<div class="d-flex align-items-center gap-2">
					...
					<a href="nova-disciplina" class="btn btn-primary btn-sm btn-new-alter px-3 py-1 ms-auto">Novo Cadastro</a>
				</div>
				...
				<table id="tabela-dados"
					class="table tabela-acessar-escolas table-striped mb-0 caption-top mx-auto table-responsive ">
						...
						<!-- 	<th scope="col" class="sortable border-end"
							...
							<th scope="col" class="sortable border-end"
								...
								<div
									...
									<div
										class="col d-flex align-items-center justify-content-between">
										<span>Carga Horária Semanal</span> <i class="fas fa-sort me-3"
											style="color: #dddddd"></i>
									</div>
								</div>
							</th>
							...
							<th scope="col" class="sortable border-end"
								...
								<div
									...
									<div
										class="col d-flex align-items-center justify-content-between">
										<span>Carga Horária Anual</span> <i class="fas fa-sort me-3"
											style="color: #dddddd"></i>
									</div>
								</div>
							</th>
