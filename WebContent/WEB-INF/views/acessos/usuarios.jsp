...
<body>
		...
		<section class="pt-4 card card-table px-5 py-3">
			<div class="mt-3 mb-3"
				...
				<div class="d-flex align-items-center gap-2 ">
					...
					<a class="btn btn-primary btn-sm btn-new-alter px-3 py-1 ms-auto"
						href="novoUsuario"> Novo Cadastro </a>
				</div>
			</div>
			...
			<table
				...
				<thead>
					<tr>
						...
						<th scope="col" class="sortable border-end" data-column="usuario">
							<div
								class="d-flex align-items-center justify-content-between pe-2">
								<div
									class="col d-flex align-items-center justify-content-between">
									<span>Usuário</span> <i class="fas fa-sort me-3"
										style="color: #dddddd"></i>
								</div>
								<div class="dropdown-form">
						...
						<th scope="col" class="sortable border-end" data-column="email">
							<div
								...
								<div
									class="col d-flex align-items-center justify-content-between">
									<span>Email</span> <i class="fas fa-sort me-3"
										style="color: #dddddd"></i>
								</div>
								<div class="dropdown-form">
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/acessos/usuarios.js"></script>
	<script charset="UTF-8"
