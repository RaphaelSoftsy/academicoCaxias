...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-graduation-cap fa-lg"></i> <span>Grade
						currícular</span>
				</div>
			</div>
		</section>
				...
				<thead>
					<tr>
						...
						<th scope="col" class="border-end pe-2 th-sem-filtro">
							Obrigatória</th>
						<th scope="col" class="border-end pe-2 th-sem-filtro">Retém
							série</th>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="cursoSerieId" class="form-label">Série:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Escola"
									id="cursoSerieId" required name="cursoSerieId">
								...
								<div class="form-control">
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio"
											name="obrigatoria" id="obrigatoriaS" value="S" />
										<label class="form-check-label" for="obrigatoriaS">Sim</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio"
											name="obrigatoria" id="obrigatoriaN" value="N" />
										<label class="form-check-label" for="obrigatoriaN">Não</label>
									</div>
								</div>
							</div>
							<div class="mb-4">
								<label for="retemSerie" class="form-label">Retém
									série:<span class="red">*</span>
								</label>
								<div class="form-control">
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="retemSerie"
											id="retemSerieS" value="S" /> <label
											class="form-check-label" for="retemSerieS">Sim</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="retemSerie"
											id="retemSerieN" value="N" /> <label
											class="form-check-label" for="retemSerieN">Não</label>
									</div>
								</div>
							</div>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							<div class="mb-4">
								<label for="cursoSerieIdEdit" class="form-label">Série:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Escola"
									id="cursoSerieIdEdit" required name="cursoSerieIdEdit">
									<option selected disabled value="">Selecione uma opção
									</option>
								</select>
							</div>
							<div class="mb-4">
								<label for="turnoIdEdit" class="form-label">Turno:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Escola"
									id="turnoIdEdit" required name="turnoIdEdit">
									<option selected disabled value="">Selecione o turno</option>
								</select>
							</div>
							<div class="mb-4">
							...
							<div class="mb-4">
								...
								<div class="form-control">
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio"
											name="obrigatoriaEdit" id="obrigatoriaSEdit" value="S" />
										<label class="form-check-label" for="obrigatoriaSEdit">Sim</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio"
											name="obrigatoriaEdit" id="obrigatoriaNEdit" value="N" />
										<label class="form-check-label" for="obrigatoriaNEdit">Não</label>
									</div>
								</div>
							</div>
							<div class="mb-4">
								<label for="retemSerieEdit" class="form-label">Retém
									série:<span class="red">*</span>
								</label>
								<div class="form-control">
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio"
											name="retemSerieEdit" id="retemSerieSEdit" value="S" />
										<label class="form-check-label" for="retemSerieSEdit">Sim</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio"
											name="retemSerieEdit" id="retemSerieNEdit" value="N" />
										<label class="form-check-label" for="retemSerieNEdit">Não</label>
									</div>
								</div>
							</div>
							<div class="d-flex justify-content-end gap-2">
								<button type="button" onclick='ativar("gradeCurricular")'
									class="ativar btn btn-secondary" data-bs-dismiss="modal">
									Ativar</button>
								<button type="button" onclick='desativar("gradeCurricular")'
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/cursos/gradeCurricular.js"></script>
	<script charset="UTF-8"
