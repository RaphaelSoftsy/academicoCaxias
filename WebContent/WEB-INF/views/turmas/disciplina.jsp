...
<html>
  ...
  <body>
    ...
    <main class="py-4 container-res">
      ...
      <section class="pt-4 card card-table px-5 py-3">
        ...
        >
          ...
          <thead>
            <tr>
              <th scope="col" class="sortable border-end" data-column="turma">
                <div
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/turmas/disciplina.js"></script>
