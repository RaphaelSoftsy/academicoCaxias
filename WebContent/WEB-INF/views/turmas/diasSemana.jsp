		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-school fa-lg"></i> <span>Dias da
						Semana</span>
				</div>
			</div>
		</section>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							...
							<div class="mb-4">
								<label for="diaSemana" class="form-label">Dia
									da Semana:<span class="red">*</span>
							...
							<div class="mb-4">
								<label for="horaInicio" class="form-label">Hora
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="mb-4">
								<label for="diaSemanaEdit" class="form-label">Dia
									da Semana:<span class="red">*</span>
							...
							<div class="mb-4">
								<label for="horaInicioEdit" class="form-label">Hora
									de Início:<span class="red">*</span>
							...
							<div class="mb-4">
								<div class="col-md-12">
									...
									<div class="form-control card-form-infra">
										<label for="permiteChoqueHorarioEdit">Sim</label> <label
											class="switch"> <input type="checkbox"
											id="permiteChoqueHorarioEdit" name="permiteChoqueHorarioEdit" />
											<span class="slider"></span>
										</label> <label for="permiteChoqueHorarioEdit">Não</label>
									</div>
								</div>
							</div>
							<div class="d-flex justify-content-end gap-2">
