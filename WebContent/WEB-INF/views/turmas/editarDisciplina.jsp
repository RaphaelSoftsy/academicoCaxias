...
<html>
  ...
  <body>
        ...
        >
          ...
          <div class="row mb-4">
            <div class="col-md-6">
              <button
                type="button"
                onclick='ativar2("turmaDisciplina")'
              ...
              <button
                type="button"
                onclick='desativar2("turmaDisciplina")'
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/turmas/editarDisciplina.js"></script>
