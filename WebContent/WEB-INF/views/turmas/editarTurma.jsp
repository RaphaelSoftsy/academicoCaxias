...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-plus fa-lg"></i><span>Editar Turma</span>
				</div>
			</div>
		</section>
		<section class="pt-4">
			<form id="formEditar"
				...
				<h1 id="tituloForm" class="text-center mb-5">Dados da Turma</h1>
				...
				<div class="row mb-3">
					...
					<div class="col-md-6">
						<label for="numTurma" class="form-label">Nº da Turma:<span
							class="red">*</span>
						</label> <input type="tel" id="numTurma" required autocomplete="off"
	...
	<script charset="UTF-8" 
		src="<%=contextPath%>/resources/assets/js/turmas/editarTurma.js"></script>
