    ...
    <main class="py-4 container-res">
      ...
      <section class="pt-4">
        ...
        >
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-4 mb-3">
              <label for="periodo" class="form-label"
                >Período:<span class="red">*</span></label
              >
              <select
                class="form-select"
                aria-label="Período"
          ...
          <div id="messageInfo" class="d-flex justify-content-center mt-4">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formEdit">
                <div class="mb-4">
                  <label for="escolaIdDisable" class="form-label"
                ...
                <div class="mb-4">
                  <label for="disciplinaIdDisable" class="form-label"
                    >Disciplina:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Disciplina"
                    id="disciplinaIdDisable"
                    required
                    name="disciplinaIdDisable"
                  >
                    <option selected disabled value="">
                      Selecione uma opção
                    </option>
                ...
                <div class="mb-4">
                  <label for="periodoLetivoId" class="form-label"
                    >Ano/Periodo:<span class="red">*</span>
                  </label>
                  <div class="custom-select">
                    <input
                      type="text"
                      id="turmaSearchPeriodoLetivo"
                      class="form-control"
