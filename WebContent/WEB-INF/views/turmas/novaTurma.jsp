	...
	<main class="py-4 container-res">
		...
		<section class="pt-4">
			<form id="formNovoCadastro"
				...
				<div class="row mb-3">
					<div class="col-md-6">
						<label for="nomeTurma" class="form-label">Nome Turma:<span
							class="red">*</span>
						...
						<div class="form-control">
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="libras"
									id="librasS" value="S"> <label class="form-check-label"
									for="librasS">Sim</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="libras"
									id="librasN" value="N"> <label class="form-check-label"
									for="librasN">Não</label>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						...
						<div class="form-control">
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio"
									name="controlaVagas" id="cvS" value="S"> <label
									class="form-check-label" for="cvS">Sim</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio"
									name="controlaVagas" id="cvN" value="N"> <label
									class="form-check-label" for="cvN">Não</label>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row mb-3 mt-3">
					...
					<div class="col-md-4">
						<label for="cursoIdLista" class="form-label">Buscar grade curricular:</label> <select
					...
					<div class="col-md-3 align-self-end">
						<button class="btn btn-warning px-5 btn-new-alter" id="btn-buscar"
							style="font-weight: 500" onclick="getGrade(event)">Buscar</button>
