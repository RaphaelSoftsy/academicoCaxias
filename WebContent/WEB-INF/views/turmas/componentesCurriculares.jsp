...
<html>
  ...
  <body>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formCadastro">
                <div class="mb-4">
                  <label for="componentesCurricularesId" class="form-label"
                    >Componente Curricular:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Componente Curricular"
                    id="componentesCurricularesId"
                    required
                    name="componentesCurricularesId"
                  >
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formEdit">
                ...
                <div class="mb-4">
                  <label for="componentesCurricularesIdEdit" class="form-label"
                    >Componente Curricular:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Componente Curricular"
                    id="componentesCurricularesIdEdit"
                    required
                    name="componentesCurricularesIdEdit"
                  >
                ...
                <div class="d-flex justify-content-end gap-2">
                  <button
                    type="button"
                    onclick='remover("turmaComponentesCurriculares")'
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/turmas/componentesCurriculares.js"></script>
