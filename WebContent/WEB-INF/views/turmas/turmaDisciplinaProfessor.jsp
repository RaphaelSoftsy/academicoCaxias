		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-link"></i><span id="span-title">Turma
						Disciplina Professor</span>
				</div>
			</div>
		</section>
		<section class="pt-4">
			<form id="formNovoCadastro"
				...
				<div class="row mb-3">
					...
					<div class="col-md-3 align-self-end">
						<a class="btn btn-warning px-5" id="btn-buscar"
							style="font-weight: 500">Buscar Professores
						</a>
					</div>
				</div>
				...
				<div class="col-md-12 text-end mt-3 mb-5">
					<a data-bs-toggle="modal" data-bs-target="#editItem"
						class="btn btn-primary px-5" id="btn-save"
						onclick="adicionarTurma()">Adicionar turma</a>
				</div>
			</form>
		</section>
						...
						<form id="formEdit">
							...
							<div class="mb-4">
								...
								<div class="custom-select">
									<input type="text" id="turmaSearchPeriodoLetivo" class="form-control"
										placeholder="Selecione ou pesquise..." autocomplete="off" />
									<ul class="options-list" id="turmaOptionsPeriodo"></ul>
								</div>
								<select class="form-select" aria-label="AnoPeriodo"
									id="periodoLetivoId" name="periodoLetivoId" hidden>
									<option selected disabled value="">Selecione uma opção
									</option>
								</select>
							</div>
							<div class="mb-4">
								...
								<div class="custom-select">
									<input type="text" id="turmaSearchTurno" class="form-control"
										placeholder="Selecione ou pesquise..." autocomplete="off" disabled	/>
									<ul class="options-list" id="turmaOptionsTurno"></ul>
								</div>
								<select class="form-select" aria-label="turno" id="turnoId"
									 name="turno" style="display: none">
