...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-link"></i><span id="span-title">Nota</span>
				</div>
			</div>
		</section>
		<section class="pt-4">
			<form id="formNovoCadastro"
				...
				<h3 id="tituloForm" class="text-start mb-5">Buscar Alunos</h3>
				...
				<div class="row mb-3">
					...
					<div class="col-md-2">
						<label for="cursoId" class="form-label">Curso:<span
							class="red">*</span></label><select class="form-select"
							aria-label="cursoId" id="cursoId" required name="cursoId">
					...
					<div class="col-md-2">
						<label for="disciplinaId" class="form-label">Disciplina:<span
							class="red">*</span></label> <select class="form-select"
							aria-label="disciplinaId" id="disciplinaId" required
							name="disciplinaId">
					...
					<div class="col-md-2">
						<label for="periodoLetivoId" class="form-label">Período
							letivo:</label> <select class="form-select" aria-label="periodoLetivoId"
					...
					<div class="col-md-2">
						<label for="turnoId" class="form-label">Turno:</label> <select
							class="form-select" aria-label="turnoId" id="turnoId" required
							name="turnoId">
							<option value='' selected disabled>Selecione o período
								letivo</option>
						</select>
				...
				<table
					...
					<thead>
						<tr>
							...
							<th scope="col">Código Turma Inep</th>
						</tr>
					</thead>
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/academico/nota.js"></script>
