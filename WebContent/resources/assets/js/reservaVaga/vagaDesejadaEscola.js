...
$("#escola").change(() => {
  ...
  $.ajax({
    url:
      url_base +
      `/ofertasConcurso/series/conta/${contaId}/curso/${curso}/escola/${escola}`,
    type: "get",
    async: false,
  }).done(function (data) {
    $("#serie").empty();
...
$("#serie").change(() => {
  ...
  $.ajax({
    url:
      url_base +
      `/turno/conta/${contaId}/curso/${curso}/escola/${escola}/serie/${serie}`,
    type: "get",
    async: false,
  })
    .done(function (data) {
...
$("#formSubmit").submit(function (event) {
  ...
  $.ajax({
    url:
      url_base +
      `/ofertasConcurso/curso/${curso}/turno/${turno}/serie/${serie}/escola/${escola}`,
    type: "get",
    async: false,
    beforeSend: function () {
      Swal.showLoading();
    ...
    $.ajax({
      url:
        url_base +
        `/candidatos/candidato/${candidatoId}/oferta/${data.idOfertaCurso}`,
      type: "put",
      async: false,
      error: function (e) {
        Swal.close();
