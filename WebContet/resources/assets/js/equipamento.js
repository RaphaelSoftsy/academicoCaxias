		...
		.done(function(data) {
			$.each(data, function(index, item) {
				$('#selectEdit').append($('<option>', {
					value: item.idMarcaEquipamento,
					text: item.marcaEquipamento,
					name: item.marcaEquipamento
				}));
			});
			$.each(data, function(index, item) {
...
function listarDados(dados) {
	var html = dados.map(function(item) {
		...
		return (
			...
			"</td>" +
			"<td>" +
			item.marcaEquipamentoId.marcaEquipamento +
			"</td>" +
			"<td>" +
			ativo +
			"</td>" +
			...
			item.ativo +
			'" data-idSelect="' +
			item.marcaEquipamentoId.idMarcaEquipamento +
