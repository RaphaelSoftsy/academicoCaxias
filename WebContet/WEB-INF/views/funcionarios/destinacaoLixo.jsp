...
<body>
	...
	<main class="py-4 container-res">
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-user-group fa-lg"></i> <span>Destinação Lixo</span>
				</div>
			</div>
		</section>
		<section class="pt-4 card card-table px-5 py-3">
			...
			<table
				...
				<caption>Destinação Lixo</caption>
				<thead>
					<tr>
						<th scope="col">Destinação Lixo</th>
	...
	<script
		src="<%=contextPath%>/resources//assets/js/listardestinacaoLixo.js"></script>
