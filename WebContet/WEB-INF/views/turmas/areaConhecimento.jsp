...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-bars-staggered fa-lg"></i> <span>Áreas de Conhecimento</span>
				</div>
			</div>
		</section>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							...
							<div class="mb-4">
								<label for="areaConhecimentoId" class="form-label">Área de Conhecimento:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Área de Conhecimento"
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="mb-4">
								<label for="areaConhecimentoIdEdit" class="form-label">Área de Conhecimento:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Área de Conhecimento"
							...
							<div class="d-flex justify-content-end gap-2">
								<button type="button" onclick='remover("turmaAreaConhecimento")'
	...
	<script
		src="<%=contextPath%>/resources/assets/js/turmas/areaConhecimento.js"></script>
