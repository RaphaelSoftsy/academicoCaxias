...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-people-group fa-lg"></i> <span>Pessoas</span>
				</div>
			</div>
		</section>
			...
			<table
				...
				<thead>
					<tr>
						...
						<th scope="col" class="sortable border-end" data-column="cpf">
							<div
								class="d-flex align-items-center justify-content-between pe-2">
								<div
									class="col d-flex align-items-center justify-content-between">
						...
						<th scope="col" class="sortable border-end"
							data-column="dtNascimento">
							<div
								class="d-flex align-items-center justify-content-between pe-2">
								<div
									class="col d-flex align-items-center justify-content-between">
									<span>Data de Nascimento</span> <i class="fas fa-sort me-3"
										style="color: #dddddd"></i>
								</div>
								<div class="dropdown-form">
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/pessoas/pessoas.js"></script>
	<script charset="UTF-8"
