	...
	<main class="py-4 container-res">
		...
		<section class="pt-4">
			<form id="formNovoCadastro"
				...
				<div class="row mb-3">
					<div class="col-md-6">
						<label for="codTurmaInep" class="form-label">Nome:<span
							class="red">*</span>
						</label> <input type="text" id="nome" required
							autocomplete="off" name="nome" class="form-control " />
					</div>
					<div class="col-md-6">
						<label for="codTurmaInep" class="form-label">CPF:<span
							class="red">*</span>
						</label> <input type="text" id="cpf" required
							autocomplete="off" name="cpf" class="form-control " />
					</div>
				</div>
