...
<html>
  ...
  <body>
    ...
    <main class="py-4 container-res">
      ...
      <section class="pt-4">
        ...
        >
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              <label for="nomePai" class="form-label"
                >Nome do Pai:<span class="red">*</span>
              </label>
              <input
                type="text"
                id="nomePai"
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              <label for="codTurmaInep" class="form-label"
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/pessoas/editarPessoa.js"></script>
