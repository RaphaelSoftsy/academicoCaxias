...
<html>
  ...
  <body>
              ...
              <form id="formCadastro">
                <div class="mb-4">
                  <label for="modalidadeEscolaId" class="form-label"
                    >Modalidade:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
            ...
            <div class="modal-body">
              <form id="formEdit">
                ...
                <div class="d-flex justify-content-end gap-2">
                  <button
                    type="button"
                    onclick='remover("escolaModalidade")'
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/escolas/escolaModalidade.js"></script>
