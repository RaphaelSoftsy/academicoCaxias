...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-school fa-lg"></i> <span>Esgotamento Sanitário</span>
				</div>
			</div>
		</section>
				...
				<thead>
					<tr>
						...
						<th scope="col" class="sortable border-end"
							data-column="esgotamentoSanitario">
							<div
								class='d-flex align-items-center justify-content-between pe-2'>
								<div
									class="col d-flex align-items-center justify-content-between">
									<span>Esgotamento Sanitário</span> <i class="fas fa-sort me-3"
										style="color: #dddddd"></i>
								</div>
								<div class="dropdown-form">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							...
							<div class="mb-4">
								<label for="idEsgotamentoSanitario" class="form-label">Esgotamento Sanitário:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Esgotamento Sanitário"
									id="idEsgotamentoSanitario" required name="idEsgotamentoSanitario">
									<option selected value='' disabled>Selecione o Esgotamento</option>
								</select>
							</div>
							<div class="mb-4">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="mb-4">
								<label for="idEsgotamentoSanitarioEdit" class="form-label">Esgotamento Sanitário:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Esgotamento Sanitário"
									id="idEsgotamentoSanitarioEdit" required name="idEsgotamentoSanitarioEdit">
									<option selected value='' disabled>Selecione o Esgotamento</option>
								</select>
							</div>
							<div class="d-flex justify-content-end gap-2">
								<button type="button" onclick='remover("escolaEsgotamentoSanitario")'
	...
	<script
		src="<%=contextPath%>/resources/assets/js/escolas/esgotamentoSanitario.js"></script>
