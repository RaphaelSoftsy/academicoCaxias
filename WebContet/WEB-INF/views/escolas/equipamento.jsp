					...
					<tr>
						...
						<th scope="col" class="sortable border-end"
							...
							<div
								...
								<div
									class="col d-flex align-items-center justify-content-between">
									<span>Equipamento</span> <i class="fas fa-sort me-3"
										style="color: #dddddd"></i>
								</div>
								<div class="dropdown-form">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="mb-4">
								<label for="equipamentoIdEdit" class="form-label">Equipamento:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Equipamento"
									id="equipamentoIdEdit" required name="equipamentoIdEdit">
							...
							<div class="d-flex justify-content-end gap-2">
							<button type="button" onclick='ativar("escolaEquipamento")'
									class="ativar btn btn-secondary" data-bs-dismiss="modal">Ativar</button>
								<button type="button" onclick='desativar("escolaEquipamento")'
