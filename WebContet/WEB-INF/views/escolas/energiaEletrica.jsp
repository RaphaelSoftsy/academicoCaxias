...
<html>
  ...
  <body>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formCadastro">
                <div class="mb-4">
                  <label for="idFonteEnergiaEletrica" class="form-label"
                    >Fonte de Energia:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Fonte de Energia"
                    id="idFonteEnergiaEletrica"
                    required
                    name="idFonteEnergiaEletrica"
                  >
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formEdit">
                ...
                <div class="mb-4">
                  <label for="idFonteEnergiaEletricaEdit" class="form-label"
                    >Fonte de Energia:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Fonte de Energia"
                    id="idFonteEnergiaEletricaEdit"
                    required
                    name="idFonteEnergiaEletricaEdit"
                  >
                    <option selected value="" disabled>
                      Selecione a Fonte de Energia
                    </option>
                ...
                <div class="d-flex justify-content-end gap-2">
                  <button
                    type="button"
                    onclick='remover("escolaFonteEnergiaEletrica")'
    ...
    <script src="<%=contextPath%>/resources/assets/js/escolas/energiaEletrica.js"></script>
