...
<html>
  ...
  <body>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formCadastro">
                <div class="mb-4">
                  <label for="idFornecimentoAgua" class="form-label"
                    >Fornecimento de Água:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Fornecimento de Água"
                    id="idFornecimentoAgua"
                    required
                    name="idFornecimentoAgua"
                  >
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formEdit">
                ...
                <div class="mb-4">
                  <label for="idFornecimentoAguaEdit" class="form-label"
                    >Fornecimento de Água:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Fornecimento de Água"
                    id="idFornecimentoAguaEdit"
                    required
                    name="idFornecimentoAguaEdit"
                  >
                    <option selected value="" disabled>
                      Selecione o Fornecimento
                    </option>
                ...
                <div class="d-flex justify-content-end gap-2">
                  <button
                    type="button"
                    onclick='remover("escolaFornecimentoAgua")'
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/escolas/fornecimentoAgua.js"></script>
