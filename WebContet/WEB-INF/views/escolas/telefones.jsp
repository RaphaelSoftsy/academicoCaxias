...
<html>
  ...
  <body>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formCadastro">
                ...
                <div class="mb-4">
                  <label for="idTipoTelefone" class="form-label"
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formEdit">
                <div class="mb-4">
                  <label for="telefoneEdit" class="form-label"
                    >Telefone:<span class="red">*</span></label
                  >
                  <input
                    type="tel"
                ...
                <div class="mb-4">
                  <label for="idTipoTelefoneEdit" class="form-label"
                    >Tipo de Telefone:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Tipo de Telefone"
                    id="idTipoTelefoneEdit"
                    required
                    name="idTipoTelefoneEdit"
                  >
                    <option selected value="" disabled>Selecione o Tipo</option>
                  </select>
                </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                  <button
                    type="button"
                    onclick='remover("escolaTelefone")'
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/escolas/telefones.js"></script>
