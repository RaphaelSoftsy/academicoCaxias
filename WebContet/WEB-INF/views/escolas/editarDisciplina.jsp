...
<html>
  ...
  <body>
          ...
          <div class="row mb-5 justify-content-center">
            ...
            <div class="col-md-8">
              <button
                ...
                class="ativar btn btn-secondary mt-4"
              ...
              <button
                ...
                class="desativar btn btn-secondary mt-4"
                data-bs-dismiss="modal"
              >
                Desativar
              </button>
    ...
    <script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/escolas/editarDisciplina.js"></script>
