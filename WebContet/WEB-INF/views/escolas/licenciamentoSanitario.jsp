...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-school fa-lg"></i> <span>Licenciamentos
						Sanitários</span>
				</div>
			</div>
		</section>
					...
					<tr>
						...
						<th scope="col" class="sortable border-end"
							...
							<div
								...
								<div
									class="col d-flex align-items-center justify-content-between">
									<span>Licenciamento</span> <i class="fas fa-sort me-3"
										style="color: #dddddd"></i>
								</div>
								<div class="dropdown-form">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							...
							<div class="mb-4">
								<label for="licSanitario" class="form-label">Licenciamento
									Sanitário:<span class="red">*</span>
								</label> <input type="text" class="form-control" id="licSanitario"
									name="licSanitario" required
									aria-describedby="Licenciamento Sanitário" autocomplete="off">
							</div>
							<div class="mb-4">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="mb-4">
								<label for="licSanitarioEdit" class="form-label">Licenciamento
									Sanitário:<span class="red">*</span>
								</label> <input type="text" class="form-control" id="licSanitarioEdit"
									name="licSanitarioEdit" required
									aria-describedby="Licenciamento Sanitário" autocomplete="off">
							</div>
							<div class="mb-4">
							...
							<div class="d-flex justify-content-end gap-2">
								<button type="button" onclick='remover("escolaLicSanitario")'
	...
	<script
		src="<%=contextPath%>/resources/assets/js/escolas/licenciamentoSanitario.js"></script>
