...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-school fa-lg"></i> <span>Profissionais</span>
				</div>
			</div>
		</section>
				...
				<thead>
					<tr>
						...
						<th scope="col" class="sortable border-end"
							data-column="tipoProfissional">
							<div
								class='d-flex align-items-center justify-content-between pe-2'>
								<div
									class="col d-flex align-items-center justify-content-between">
									<span>Tipo Profissional</span> <i class="fas fa-sort me-3"
										style="color: #dddddd"></i>
								</div>
								<div class="dropdown-form">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="mb-4">
							...
							<div class="mb-4">
								<label for="tipoProfissionalId" class="form-label">Tipo Profissional:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Profissional"
									id="tipoProfissionalId" required name="tipoProfissionalId">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="mb-4">
								<label for="tipoProfissionalIdEdit" class="form-label">Tipo Profissional:<span
									class="red">*</span>
								</label> <select class="form-select" aria-label="Profissional"
									id="tipoProfissionalIdEdit" required name="tipoProfissionalIdEdit">
							...
							<div class="d-flex justify-content-end gap-2">
								<button type="button" onclick='remover("escolaProfissional")'
	...
	<script
		src="<%=contextPath%>/resources/assets/js/escolas/profissional.js"></script>
