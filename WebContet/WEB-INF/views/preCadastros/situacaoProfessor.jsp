...
<body>
	...
	<main class="py-4 container-res">
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-cogs fa-lg"></i> <span>Situação Professor</span>
				</div>
			</div>
		</section>
		<section class="pt-4 card card-table px-5 py-3">
			...
			<table
				...
				<thead>
					<tr>
						<th scope="col">Situação do Professor</th>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="nome" class="form-label">Situação do Professor:</label> <input
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="d-flex justify-content-end gap-2">
							<button type="button" onclick='ativar("situacaoProfessor")' class="ativar btn btn-secondary"
									data-bs-dismiss="modal">Ativar</button>
							<button type="button" onclick='desativar("situacaoProfessor")' class="desativar btn btn-secondary"
	...
	<script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/situacaoProfessor.js"></script>
