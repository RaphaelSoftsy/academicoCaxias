...
<body>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="cadastro-nome" class="form-label">Concurso:</label> <input
							...
							<div class="mb-4">
								<label for="dataFechamento" class="form-label">Data Fechamento:<span class="red">*</span>
								</label> <input autocomplete="off" type="date" id="dataFechamento"
									name="dataFechamento" class="form-control" />
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="mb-4">
								<label for="edit-nome2" class="form-label">Data Início:</label> <input
									type="text" class="form-control" id="edit-nome2" required
									aria-describedby="Descricao 2" autocomplete="off">
							</div>
							<div class="mb-4">
								<label for="horaInicioEdit" class="form-label">Data Fechamento:<span class="red">*</span>
	...
	<script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/concurso.js"></script>
