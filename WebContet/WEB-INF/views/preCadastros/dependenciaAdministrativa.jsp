...
<!-- Sweetalert -->
    ...
    <script charset="UTF-8"  src="sweetalert2.all.min.js"></script><!-- CSS -->
...
<body>
	...
	<script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/dependenciaAdministrativa.js"></script>
