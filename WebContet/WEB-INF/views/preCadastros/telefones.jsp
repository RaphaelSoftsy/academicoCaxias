...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-cogs fa-lg"></i> <span>Tipo Telefone</span>
				</div>
			</div>
		</section>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="nome" class="form-label">Tipo de Telefone:</label> <input
	...
	<script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/telefones.js"></script>
