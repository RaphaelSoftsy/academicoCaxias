...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-cogs fa-lg"></i> <span>Nacionalidades</span>
				</div>
			</div>
		</section>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="nome" class="form-label">Nacionalidade:</label> <input
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="d-flex justify-content-end gap-2">
							<button type="button" onclick='ativar("nacionalidade")' class="ativar btn btn-secondary"
									data-bs-dismiss="modal">Ativar</button>
							<button type="button" onclick='desativar("nacionalidade")' class="desativar btn btn-secondary"
	...
	<script charset="UTF-8"  src="<%=contextPath%>/resources/assets/js/nacionalidade.js"></script>
