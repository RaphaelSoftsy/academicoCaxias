...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-cogs fa-lg"></i> <span>Áreas de Conhecimento</span>
				</div>
			</div>
		</section>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="nome" class="form-label">Área de Conhecimento:</label> <input
	...
	<script src="<%=contextPath%>/resources/assets/js/areaConhecimento.js"></script>
