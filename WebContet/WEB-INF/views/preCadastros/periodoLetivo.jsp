...
<html>
  ...
  <body>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formCadastro">
                ...
                <div class="row mb-4">
                  <div class="col-6">
                    <label for="dtInicio" class="form-label"
                      >Data início:<span class="red">*</span>
                    </label>
                    <input
                      max="2999-01-01"
                      autocomplete="off"
                ...
                <div class="mb-4">
                  <label for="tipoPeriodicidade" class="form-label"
                    >Tipo da periodicidade:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Tipo da periodicidade"
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formEdit">
                ...
                <div class="row mb-4">
                  <div class="col-6">
                    <label for="anoEdit" class="form-label"
                      >Ano:<span class="red">*</span>
                    </label>
                    <select
                      class="form-select"
                  ...
                  <div class="col-6">
                    <label for="periodoEdit" class="form-label"
                      >Período:<span class="red">*</span>
                    </label>
                    <select
                      class="form-select"
                      aria-label="periodoEdit"
                      id="periodoEdit"
                      required
                      name="periodoEdit"
                    >
                ...
                <div class="row mb-4">
                  <div class="col-6">
                    <label for="dtInicioEdit" class="form-label"
                      >Data início:<span class="red">*</span>
                    </label>
                    <input
                      max="2999-01-01"
                  ...
                  <div class="col-6">
                    <label for="dtFimEdit" class="form-label"
                      >Data fim:<span class="red">*</span>
                    </label>
                    <input
                      max="2999-01-01"
                ...
                <div class="mb-4">
                  <label for="tipoPeriodicidadeEdit" class="form-label"
                    >Tipo da periodicidade:<span class="red">*</span>
                  </label>
                  <select
                    class="form-select"
                    aria-label="Tipo da periodicidade"
                    id="tipoPeriodicidadeEdit"
                    required
                ...
                <div class="d-flex justify-content-end gap-2">
                  ...
                  <button
                    type="button"
                    onclick='desativar("periodoletivo")'
    ...
    <script src="<%=contextPath%>/resources/assets/js/periodoLetivo.js"></script>
