    ...
    <main class="py-4 container-res">
      ...
      <section class="pt-4 card card-table px-5 py-3">
        ...
        >
          ...
          <thead>
            <tr>
				<th scope="col" class="sortable border-end" data-column="cursoSerie">
					<div
			...
			<th scope="col" class="border-end pe-2 th-sem-filtro">Obrigatória</th>
			<th scope="col" class="border-end pe-2 th-sem-filtro">Retém série
			</th>
