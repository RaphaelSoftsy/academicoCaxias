...
<body>
		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-pager"></i> <span>Padrões de Acesso</span>
				</div>
			</div>
		</section>
			...
			<table
				...
				<thead>
					<tr>
						<th scope="col" class="sortable border-end" data-column="escolaId">
							<div
								...
								<div
									...
									<span>Padrão</span> <i class="fas fa-sort me-3"
						...
						<th scope="col" width="15%" class="border-end pe-2 th-sem-filtro">Ações</th>
					</tr>
				</thead>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formCadastro">
							<div class="mb-4">
								<label for="padraoAcessoName" class="form-label">Padrão
									Acesso:<span class="red">*</span>
								</label> <input type="text" id="padraoAcessoName" required
									autocomplete="off" name="padraoAcessoName" class="form-control" />
							</div>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							<div class="mb-4">
								<label for="padraoAcessoNameEdit" class="form-label">Padrão
									Acesso:<span class="red">*</span>
								</label> <input type="text" id="padraoAcessoNameEdit" required
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/acessos/padraoAcesso.js"></script>
	<script charset="UTF-8"
